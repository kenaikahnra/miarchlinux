...
pacstrap /mnt base base-devel linux linux-firmware grub os-prober efibootmgr sudo nano intel-ucode xorg xorg-xinit nvidia nvidia-utils networkmanager ntfs-3g git
...
do
    ...
    case $pEscritorio in
        1)
            echo "Instalando Kde"
            pacstrap /mnt plasma-desktop user-manager konsole dolphin firefox kate breeze-gtk kde-gtk-config libappindicator-gtk3 plasma-nm plasma-pa ark okular kinfocenter kwalletmanager transmission-qt gwenview kipi-plugins spectacle kcolorchooser vlc konversation
            break
            ;;
        2)
